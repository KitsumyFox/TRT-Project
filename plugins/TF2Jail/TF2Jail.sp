...
public void OnPluginStart()
{
	...
	RegConsoleCmd("sm_pr", Command_PardonAllReds, "Pardons all reds.");
...
/* Player Commands ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
public Action Command_PardonAllReds(int client, int args)
{
	...
	if (WardenExists())
	{
		for (int i = 1; i <= MaxClients; i++)
		{
			if (IsClientInGame(i) && (!IsFakeClient(i)) && IsPlayerAlive(i) && TF2_GetClientTeam(i) == TFTeam_Red)
			{
				ClearRebel(i);
			}
		}
